...
powiaty <- st_read(dsn = '../data/Powiaty.shp')
as.tibble(powiaty)
...
malzenstwa <- readxl::read_xlsx('../data/Malzenstwa.xlsx', sheet = 2)
...
skolaryzacja  <- readxl::read_xlsx('../data/Skolaryzacja.xlsx', sheet = 2)
as.tibble(skolaryzacja)

ludnosc  <- readxl::read_xlsx('../data/Ludnosc.xlsx', sheet = 2)
as.tibble(ludnosc)
ludnosc %>% mutate(ludnosc_ogolem = `ogółem`) -> noweludnosc
as.tibble(noweludnosc)

gestosc  <- readxl::read_xlsx('../data/Gestosc.xlsx', sheet = 2)
as.tibble(gestosc)
