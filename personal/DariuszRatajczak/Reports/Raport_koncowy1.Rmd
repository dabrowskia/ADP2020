...
```{r,echo=FALSE,message = FALSE,warning = FALSE,include = FALSE}
setwd("J:/ADP2020/personal/DariuszRatajczak")
```
```{r,echo=FALSE,message = FALSE,warning = FALSE,include = FALSE}
# Wczytanie danych i przygotowanie danych

powiaty <- st_read("../data/Powiaty.shp")
powiaty$JPT_KOD_JE <-paste0(powiaty$JPT_KOD_JE, '000')

kina <- read.xlsx('../data/kina_tylko.xlsx')

sport <- read.xlsx('../data/sport_tylko.xlsx')

ludnosc <- read.xlsx('../data/ludnosc_tylko.xlsx')
...
$$ y = -0.861039  * ilość klubów + 0.083766 * ilość trenerów + 0.010695 * ilość ćwiczących +  1.913271 $$
