...
powiaty <- st_read("D:/1. Studia/2. Magisterka/4. semestr/2. Analiza Danych Przestrzennych/1. Projekt/1. Gotowy — kopia — kopia/Projekt/Powiaty.shp", stringsAsFactors = F)
```
